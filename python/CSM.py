...
tfs = (Math.abs((3.0 - s) * Math.pow(q, (3.0 - n) / (n - s)) * Math.pow(A * gn,(s - 3.0) / (n - s)) / (4.0 * Math.PI * Math.pow(betaf,3.0 - s))) ** (n - s);
...
callback.args["rho"] = rho_slider
callback.args["r0"] = r0_slider
